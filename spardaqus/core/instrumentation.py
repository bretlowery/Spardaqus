...
from spardaqus.core.utils import containsdupevalues, exception, info, nowint, nowstr
...
class InstrumentationManager:
    ...
    def get(self, tag="main"):
        ...
        try:
            ...
            exception("SpardaqusInstrumentation instrument or player not found; was the integration registered?")
